 ...
 */
static const char m_target_periph_name[] = "BSc_peripheral";          /**< If you want to connect to a peripheral using a given advertising name, type its name here. */
...
{
			// Jeg ønsker å bruke denne funksjonen og adressen til peripheralen er F1:08:53:70:63:A7
			// som jeg har skrevet inn under, men det ser ikke ut til å funke..
    ...
    .addr      = {0xF1, 0x08, 0x53, 0x70, 0x63, 0xA7}
};
    ...
    switch (p_hrs_c_evt->evt_type)
    {
        ...
        case BLE_HRS_C_EVT_HRM_NOTIFICATION:
        {
            //NRF_LOG_INFO("Heart Rate = %d.\r\n", p_hrs_c_evt->params.hrm.hr_value);
						...
						//ble_hrs_body_sensor_location_set(&m_ble_hrs_c, open_door);
						
						ble_gattc_write_params_t write_params =
						{
								.write_op			= BLE_GATT_OP_WRITE_CMD,
								.flags				= BLE_GATT_EXEC_WRITE_FLAG_PREPARED_WRITE,
								.handle				= m_ble_hrs_c.bsl_c_handles.value_handle,
								.offset				= 0,
								.len					= 1,
								.p_value			= &open_door	
						};
						sd_ble_gattc_write(m_ble_hrs_c.conn_handle, &write_params);
						nrf_drv_gpiote_out_toggle(PIN_OUT);
						
						// Her må jeg skrive til 'Body Sensor Location' slik at BLE_GATTS_EVT_WRITE eventen i peripheralen kjører igjen, og dermed stopper in_pin_handler();
...
void write_to_c(void)
{
		...
		write_params.handle   = m_ble_hrs_c.bsl_c_handles.cccd_handle;
		write_params.offset   = 0;
		write_params.len			= 1;
		write_params.p_value	= &close_door;
